    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_url', models.ImageField(blank=True, null=True, upload_to='category/%Y/%m/%d')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('img_url', models.ImageField(blank=True, null=True, upload_to='product/%Y/%m/%d')),
                ('alt_text', models.CharField(default='Product images', max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('product_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='media', to='inventory.productitem')),
            ],
        ),
        migrations.CreateModel(
